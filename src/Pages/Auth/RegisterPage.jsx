...
const LoginPage = () => {
    ...
    // REMOVIDO: O useEffect para checkRedirect foi removido.
    ...
    // RESTAURADO: Usa signInWithPopup (Pop-up)
    const handleGoogleLogin = async () => {
        setError('');
        try {
            // Usa o método de Pop-up para funcionar no localhost
